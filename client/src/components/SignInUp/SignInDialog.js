...
export function SignInDialog() {
	...
	const handleSignIn = () => {
		...
		if (selectors.areAllValid()) {
			...
			dispatch(authActions.saga.signin.request({ ...validState, setOpenModal }));
		}
	}
	...
	return (
		<>
			<DialogTitle id='dialog-title' className={stylesheet.dialogTitle}>SIGN IN</DialogTitle>
			<DialogContent>
				...
				<FormControl fullWidth={true} >
					<Typography
						className={stylesheet.forgotPassword}
						variant='caption'
						align='right'
...
registerModal('signIn', SignInDialog);
